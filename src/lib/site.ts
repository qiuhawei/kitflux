...
export const siteConfig = {
  ...
  description:
    "Free AI tools for ChatGPT, Claude, and Gemini: token counter, prompt builder, and API cost calculator — plus JSON, video, and developer utilities. Private browser tools, no signup.",
